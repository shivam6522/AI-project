...
public class UCSupdated
{
    ...
    public UCSupdated(int numberOfNodes, int edges)
    {
    ...
    public int Heuristic(int node, ArrayList<Integer> visited)
    {
    	...
    	if(!(visited.contains(node)))
    	{
            ...
            {
            	if( adjacencyMatrix[node][j] != MAX_VALUE && !(visited.contains(j)))
            		n_edges = n_edges-2;
            }
    	}
    	...
    	//System.out.println("no of edges are"+n_edges);
		HeuristicFunction heuristicFunction = new HeuristicFunction(v, (n_edges/2+1)); 
    ...
    public static void main(String... arg)
    {
       ...
       // int destination = 0;
        ...
        try
        {
            ...
            UCSupdated uniformCostSearch = new UCSupdated(number_of_vertices, no_of_edges);
